...
This project is indexed by GitNexus as **.closeclaw** (2164 symbols, 4202 relationships, 143 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
