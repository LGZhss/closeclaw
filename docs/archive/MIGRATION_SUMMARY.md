...
- [x] `groups/global/CONTEXT.md` - 全局记忆文件
- [x] `groups/main/CONTEXT.md` - 主通道记忆文件
...
### 4. 分层记忆
- `groups/global/CONTEXT.md` - 全局共享记忆
- `groups/{name}/CONTEXT.md` - 群组独立记忆
- 基于 CONTEXT.md 的上下文加载
