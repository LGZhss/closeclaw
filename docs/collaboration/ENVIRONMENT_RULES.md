...
| 协作规则 | `docs/collaboration/COLLABORATION_RULES_v3.md` | 是否存在、版本号 |
| IDE引导 | `docs/collaboration/IDE_ONBOARDING.md` | 是否存在 |
| 环境规则 | `docs/collaboration/ENVIRONMENT_RULES.md` | 是否存在 |
| 注册流程 | `docs/collaboration/REGISTRATION_FLOW.md` | 是否存在 |
| 规划任务 | `docs/planning/TASK_PLANNING.md` | 是否存在 |
