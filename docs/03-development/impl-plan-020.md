...
> [!WARNING]
> **已归档 / 历史保留文档**
> 本文档记录了原始的 P020 架解耦实施规划 (Phase 0 ~ Phase 5)。
> - Phase 0-2 已在 P021 中实际实施完毕。
> - Phase 3 及之后的规划，已被 **P026（MCP 协议栈演进）** 与 **P027（Dart+Go+TypeScript 三语言微内核）** 正式取代。
> 本文件仅作历史与代码参考保留。

> **文档版本**: 1.0
> **关联提案**: proposal-020（已过期/部分被取代）
> **面向读者**: 历史研究者 / 考古用途
> **阅读须知**: 仅供查阅历史任务切分逻辑。
