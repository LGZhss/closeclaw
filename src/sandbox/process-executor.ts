...
// Optimization: Cache os.tmpdir() to avoid synchronous environment variable reads on every execution
...
export class ProcessExecutor {
  ...
  async execute(
    ...
    const tempFile = path.join(OS_TMP_DIR, `temp_${executionId}.js`);
