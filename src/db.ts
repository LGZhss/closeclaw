...
// Message operations
let insertMessageStmt: ReturnType<typeof db.prepare> | undefined;
...
let getUnprocessedMessagesStmt: ReturnType<typeof db.prepare> | undefined;
export function getUnprocessedMessages(limit: number = 100): DbMessage[] {
  if (!getUnprocessedMessagesStmt)
    ...
    LIMIT ?
  `);
  return (getUnprocessedMessagesStmt as any).all(limit) as DbMessage[];
}

let markMessagesProcessedStmt: ReturnType<typeof db.prepare> | undefined;
export function markMessagesProcessed(ids: number[]): void {
  ...
  (markMessagesProcessedStmt as any).run(JSON.stringify(ids));
}

let getMessagesSinceStmt: ReturnType<typeof db.prepare> | undefined;
...
let setRegisteredGroupStmt: ReturnType<typeof db.prepare> | undefined;
...
let getRegisteredGroupStmt: ReturnType<typeof db.prepare> | undefined;
export function getRegisteredGroup(jid: string): RegisteredGroup | null {
  ...
  const row = (getRegisteredGroupStmt as any).get(jid) as any;
  if (!row) return null;
...
let getRegisteredGroupByFolderStmt: ReturnType<typeof db.prepare> | undefined;
export function getRegisteredGroupByFolder(
  ...
  const row = (getRegisteredGroupByFolderStmt as any).get(folder) as any;
  if (!row) return null;
...
let getAllRegisteredGroupsStmt: ReturnType<typeof db.prepare> | undefined;
...
let deleteRegisteredGroupStmt: ReturnType<typeof db.prepare> | undefined;
export function deleteRegisteredGroup(jid: string): void {
  if (!deleteRegisteredGroupStmt)
    deleteRegisteredGroupStmt = db.prepare(
      "DELETE FROM registered_groups WHERE jid = ?",
    );
  (deleteRegisteredGroupStmt as any).run(jid);
}

let getMainGroupStmt: ReturnType<typeof db.prepare> | undefined;
...
let insertTaskStmt: ReturnType<typeof db.prepare> | undefined;
...
let getDueTasksStmt: ReturnType<typeof db.prepare> | undefined;
...
let updateTaskNextRunStmt: ReturnType<typeof db.prepare> | undefined;
...
let getTasksByGroupStmt: ReturnType<typeof db.prepare> | undefined;
...
let getAllTasksStmt: ReturnType<typeof db.prepare> | undefined;
...
let getTaskStmt: ReturnType<typeof db.prepare> | undefined;
...
let deleteTaskStmt: ReturnType<typeof db.prepare> | undefined;
...
let insertTaskLogStmt: ReturnType<typeof db.prepare> | undefined;
...
let getTaskLogsStmt: ReturnType<typeof db.prepare> | undefined;
...
// Session operations
let setSessionStmt: ReturnType<typeof db.prepare> | undefined;
...
let getSessionStmt: ReturnType<typeof db.prepare> | undefined;
...
let setRouterStateStmt: ReturnType<typeof db.prepare> | undefined;
...
let getRouterStateStmt: ReturnType<typeof db.prepare> | undefined;
