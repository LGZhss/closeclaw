...
export const createToolRegistry = (
  ...
  return {
    ...
    read_file: async ({ path: filePath }) => {
      ...
      // Why: Prevent blocking the Node.js event loop during concurrent LLM tool execution
      // Impact: Significantly improves concurrency and responsiveness under high load
