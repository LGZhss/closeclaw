...
export const createToolRegistry = (
  ...
  return {
    ...
    read_file: async ({ path: filePath }) => {
      // What: Use async file I/O instead of sync
      // Why: Synchronous I/O blocks the Node.js event loop during concurrent tool executions.
      // Impact: Prevents main thread blocking and improves throughput for concurrent LLM tool calls.
