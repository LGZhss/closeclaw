...
This project is indexed by GitNexus as **.closeclaw** (579 symbols, 1228 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
